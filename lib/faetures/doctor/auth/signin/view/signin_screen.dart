...
class DrSignInScreen extends StatelessWidget {
  DrSignInScreen({super.key});

  final DrSignInController controller = Get.find<DrSignInController>();
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Get.toNamed(AppRoutes.DRFORGETPASSWORDSCREEN);
                            },
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Get.toNamed(AppRoutes.DRSIGNUPSCREEN);
                              },
                              child: const CustomTextWidget(
                                text: "Create account",
                                fontSize: 13,
