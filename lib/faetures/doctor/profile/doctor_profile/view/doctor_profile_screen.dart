                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            CustomTextWidget(text: "Specialist: ${doctor.specialization}"),
                            CustomTextWidget(text: "Experience: ${doctor.experience}+ years"),
                            CustomTextWidget(text: "License: ${doctor.liceneceNumber}"),
