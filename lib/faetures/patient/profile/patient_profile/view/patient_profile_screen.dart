                  ...
                  return Column(
                    ...
                    children: [
                      Center(
                        child: Column(
                          children: [
                            ...
                            CustomTextWidget(text: "Height: ${patient.height}"),
                            CustomTextWidget(text: "Weight: ${patient.weight}"),
                            CustomTextWidget(text: "Gender: ${patient.gender}"),
                            Gap(6),
                            CustomTextWidget(
                              text: patient.about!,
                      ...
                      CustomOutlineButton(onPress: () {
                        Get.to(() => PatientEditProfileScreen(), binding: BindingsBuilder(() {
                      ...
                      GestureDetector(
                        onTap: () async {
                          Get.to(PdfViewerScreen(url: patient.reportUrl!));
                        },
                        child: Container(
