...
class DrForgetPasswordScreen extends StatelessWidget {
  DrForgetPasswordScreen({super.key});

  final DrForgetPasswordController controller =
      Get.find<DrForgetPasswordController>();
