              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 35,
                     backgroundImage: patientModel!.imageUrl != null && patientModel.imageUrl!.isNotEmpty
      ? NetworkImage(patientModel.imageUrl!)
      : AssetImage(patientModel.gender?.toLowerCase() == 'female'
