...
//   const AppointmentConfirmationScreen({super.key, required this.appointment, required this.doctor,required this.patient});
...
//     // if (args == null) {
//     //   return Scaffold(
//     //     body: Center(child: Text("No appointment data provided.")),
//     //   );
//     // }
...
//             // Share PDF Button (Alternative to Preview)
//             SizedBox(
//               width: double.infinity,
//               child: OutlinedButton.icon(
...
//       // Get the Downloads directory for Android, Documents for iOS
//       Directory directory;
//       if (Platform.isAndroid) {
...
//       final fileName = 'appointment_confirmation_${DateTime.now().millisecondsSinceEpoch}.pdf';
//       final file = File('${directory.path}/$fileName');
...
//                 ScaffoldMessenger.of(context).showSnackBar(
//                   SnackBar(
//                     content: Text('Could not open PDF. Please check your device settings.'),
